...
zr_indx = np.argwhere(b_site_list == 'Zr')
ti_indx = np.argwhere(b_site_list == 'Ti')
...
for i, dir in enumerate(dirs) :
    ...
    av_zr_disp = zr_disp.mean(0)[0]
    av_ti_disp = ti_disp.mean(0)[0]
    print int(dir[2:-1]), av_zr_disp[0], av_zr_disp[1], av_zr_disp[2], av_ti_disp[0], av_ti_disp[1], av_ti_disp[2]
